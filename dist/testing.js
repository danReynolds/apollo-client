...
function validateOperation(operation) {
    ...
    for (var _i = 0, _a = Object.keys(operation); _i < _a.length; _i++) {
        ...
        if (OPERATION_FIELDS.indexOf(key) < 0) {
            throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(39) : new invariant.InvariantError(32) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(40) : new invariant.InvariantError("illegal argument: " + key);
        }
    }
    return operation;
}
...
function getFragmentQueryDocument(document, fragmentName) {
    ...
    document.definitions.forEach(function (definition) {
        if (definition.kind === 'OperationDefinition') {
            throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(75) : new invariant.InvariantError(42) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(76) : new invariant.InvariantError("Found a " + definition.operation + " operation" + (definition.name ? " named '" + definition.name.value + "'" : '') + ". " +
    ...
    if (typeof actualFragmentName === 'undefined') {
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(fragments.length === 1, 77) : invariant.invariant(fragments.length === 1, 43) : process.env.NODE_ENV === "production" ? invariant.invariant(fragments.length === 1, 78) : invariant.invariant(fragments.length === 1, "Found " + fragments.length + " fragments. `fragmentName` must be provided when there is not exactly 1 fragment.");
...
function getFragmentFromSelection(selection, fragmentMap) {
    switch (selection.kind) {
        ...
        case 'FragmentSpread': {
            ...
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(fragment, 79) : invariant.invariant(fragment, 44) : process.env.NODE_ENV === "production" ? invariant.invariant(fragment, 80) : invariant.invariant(fragment, "No fragment named " + selection.name.value + ".");
            return fragment;
        }
        default:
            return null;
...
function valueToObjectRepresentation(argObj, name, value, variables) {
    if (isIntValue(value) || isFloatValue(value)) {
        ...
        throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(27) : new invariant.InvariantError(33) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(28) : new invariant.InvariantError("The inline argument \"" + name.value + "\" of kind \"" + value.kind + "\"" +
...
function checkDocument(doc) {
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(doc && doc.kind === 'Document', 59) : invariant.invariant(doc && doc.kind === 'Document', 16) : process.env.NODE_ENV === "production" ? invariant.invariant(doc && doc.kind === 'Document', 60) : invariant.invariant(doc && doc.kind === 'Document', "Expecting a parsed GraphQL document. Perhaps you need to wrap the query string in a \"gql\" tag? http://docs.apollostack.com/apollo-client/core.html#gql");
    var operations = doc.definitions
        .filter(function (d) { return d.kind !== 'FragmentDefinition'; })
        .map(function (definition) {
        if (definition.kind !== 'OperationDefinition') {
            throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(61) : new invariant.InvariantError(17) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(62) : new invariant.InvariantError("Schema type definitions not allowed in queries. Found: \"" + definition.kind + "\"");
        }
        return definition;
    });
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(operations.length <= 1, 63) : invariant.invariant(operations.length <= 1, 18) : process.env.NODE_ENV === "production" ? invariant.invariant(operations.length <= 1, 64) : invariant.invariant(operations.length <= 1, "Ambiguous GraphQL document: contains " + operations.length + " operations");
    return doc;
}
...
function getQueryDefinition(doc) {
    ...
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(queryDef && queryDef.operation === 'query', 65) : invariant.invariant(queryDef && queryDef.operation === 'query', 19) : process.env.NODE_ENV === "production" ? invariant.invariant(queryDef && queryDef.operation === 'query', 66) : invariant.invariant(queryDef && queryDef.operation === 'query', 'Must contain a query definition.');
    return queryDef;
}
function getFragmentDefinition(doc) {
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(doc.kind === 'Document', 67) : invariant.invariant(doc.kind === 'Document', 20) : process.env.NODE_ENV === "production" ? invariant.invariant(doc.kind === 'Document', 68) : invariant.invariant(doc.kind === 'Document', "Expecting a parsed GraphQL document. Perhaps you need to wrap the query string in a \"gql\" tag? http://docs.apollostack.com/apollo-client/core.html#gql");
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(doc.definitions.length <= 1, 69) : invariant.invariant(doc.definitions.length <= 1, 21) : process.env.NODE_ENV === "production" ? invariant.invariant(doc.definitions.length <= 1, 70) : invariant.invariant(doc.definitions.length <= 1, 'Fragment must have exactly one definition.');
    var fragmentDef = doc.definitions[0];
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(fragmentDef.kind === 'FragmentDefinition', 71) : invariant.invariant(fragmentDef.kind === 'FragmentDefinition', 22) : process.env.NODE_ENV === "production" ? invariant.invariant(fragmentDef.kind === 'FragmentDefinition', 72) : invariant.invariant(fragmentDef.kind === 'FragmentDefinition', 'Must be a fragment definition.');
    return fragmentDef;
}
function getMainDefinition(queryDoc) {
    ...
    throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(73) : new invariant.InvariantError(23) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(74) : new invariant.InvariantError('Expected a parsed GraphQL query with a query, mutation, subscription, or a fragment.');
}
...
var ApolloLink = (function () {
    ...
    ApolloLink.concat = function (first, second) {
        ...
        if (isTerminating(firstLink)) {
            process.env.NODE_ENV === "production" || (process.env.NODE_ENV === "production" || invariant.invariant.warn(new LinkError("You are calling concat on a terminating link, which will have no effect", firstLink)));
            return firstLink;
        }
    ...
    ApolloLink.prototype.request = function (operation, forward) {
        throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(5) : new invariant.InvariantError(4) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(6) : new invariant.InvariantError('request is not implemented');
    };
...
var serializeFetchParameter = function (p, label) {
    ...
    try {
        ...
        var parseError = process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(7) : new invariant.InvariantError(5) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(8) : new invariant.InvariantError("Network request failed. " + label + " is not serializable: " + e.message);
...
var checkFetcher = function (fetcher) {
    if (!fetcher && typeof fetch === 'undefined') {
        ...
        if (typeof window === 'undefined')
            library = 'node-fetch';
        throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(9) : new invariant.InvariantError(6) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(10) : new invariant.InvariantError('"fetch" has not been found globally and no fetcher has been ' +
...
function shouldInclude(_a, variables) {
    ...
    return getInclusionDirectives(directives).every(function (_a) {
        ...
        if (ifArgument.value.kind === 'Variable') {
            ...
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(evaledValue !== void 0, 91) : invariant.invariant(evaledValue !== void 0, 38) : process.env.NODE_ENV === "production" ? invariant.invariant(evaledValue !== void 0, 92) : invariant.invariant(evaledValue !== void 0, "Invalid variable referenced in @" + directive.name.value + " directive.");
        }
        else {
...
function getInclusionDirectives(directives) {
    ...
    if (directives && directives.length) {
        directives.forEach(function (directive) {
            ...
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(directiveArguments && directiveArguments.length === 1, 93) : invariant.invariant(directiveArguments && directiveArguments.length === 1, 39) : process.env.NODE_ENV === "production" ? invariant.invariant(directiveArguments && directiveArguments.length === 1, 94) : invariant.invariant(directiveArguments && directiveArguments.length === 1, "Incorrect number of arguments for the @" + directiveName + " directive.");
            var ifArgument = directiveArguments[0];
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(ifArgument.name && ifArgument.name.value === 'if', 95) : invariant.invariant(ifArgument.name && ifArgument.name.value === 'if', 40) : process.env.NODE_ENV === "production" ? invariant.invariant(ifArgument.name && ifArgument.name.value === 'if', 96) : invariant.invariant(ifArgument.name && ifArgument.name.value === 'if', "Invalid argument for the @" + directiveName + " directive.");
            var ifValue = ifArgument.value;
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(ifValue &&
                (ifValue.kind === 'Variable' || ifValue.kind === 'BooleanValue'), 97) : invariant.invariant(ifValue &&
                (ifValue.kind === 'Variable' || ifValue.kind === 'BooleanValue'), 41) : process.env.NODE_ENV === "production" ? invariant.invariant(ifValue &&
                (ifValue.kind === 'Variable' || ifValue.kind === 'BooleanValue'), 98) : invariant.invariant(ifValue &&
    ...
    test: function (directive) {
        ...
        if (willRemove) {
            if (!directive.arguments ||
                ...
                process.env.NODE_ENV === "production" || (process.env.NODE_ENV === "production" || invariant.invariant.warn('Removing an @connection directive even though it does not have a key. ' +
                ...
                execute = function (selection) { return tslib.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return tslib.__generator(this, function (_a) {
                        ...
                        if (isInlineFragment(selection)) {
                            ...
                            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(fragment, 37) : invariant.invariant(fragment, 14) : process.env.NODE_ENV === "production" ? invariant.invariant(fragment, 38) : invariant.invariant(fragment, "No fragment named " + selection.name.value);
                        }
...
var Reobserver = (function () {
    ...
    Reobserver.prototype.updatePolling = function () {
        ...
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(pollInterval, 57) : invariant.invariant(pollInterval, 15) : process.env.NODE_ENV === "production" ? invariant.invariant(pollInterval, 58) : invariant.invariant(pollInterval, 'Attempted to start a polling query without a polling interval.');
...
var ObservableQuery = (function (_super) {
    ...
    ObservableQuery.prototype.refetch = function (variables) {
        ...
        if (fetchPolicy === 'cache-only') {
            return Promise.reject(process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(25) : new invariant.InvariantError(3) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(26) : new invariant.InvariantError('cache-only fetchPolicy option should not be used together with query refetch.'));
        }
    ...
    ObservableQuery.prototype.subscribeToMore = function (options) {
        ...
        var subscription = this.queryManager
            ...
            error: function (err) {
                ...
                process.env.NODE_ENV === "production" || (process.env.NODE_ENV === "production" || invariant.invariant.error('Unhandled GraphQL subscription error', err));
            },
        });
...
function defaultSubscriptionObserverErrorCallback(error) {
    process.env.NODE_ENV === "production" || (process.env.NODE_ENV === "production" || invariant.invariant.error('Unhandled error', error.message, error.stack));
}
...
var QueryManager = (function () {
    ...
    QueryManager.prototype.stop = function () {
        ...
        this.cancelPendingFetches(process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(41) : new invariant.InvariantError(24) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(42) : new invariant.InvariantError('QueryManager stopped while query was in flight'));
    };
    ...
    QueryManager.prototype.mutate = function (_a) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(mutation, 43) : invariant.invariant(mutation, 25) : process.env.NODE_ENV === "production" ? invariant.invariant(mutation, 44) : invariant.invariant(mutation, 'mutation option is required. You must specify your GraphQL document in the mutation option.');
                        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(!fetchPolicy || fetchPolicy === 'no-cache', 45) : invariant.invariant(!fetchPolicy || fetchPolicy === 'no-cache', 26) : process.env.NODE_ENV === "production" ? invariant.invariant(!fetchPolicy || fetchPolicy === 'no-cache', 46) : invariant.invariant(!fetchPolicy || fetchPolicy === 'no-cache', "Mutations only support a 'no-cache' fetchPolicy. If you don't want to disable the cache, remove your fetchPolicy setting to proceed with the default mutation behavior.");
    ...
    QueryManager.prototype.query = function (options) {
        var _this = this;
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(options.query, 47) : invariant.invariant(options.query, 27) : process.env.NODE_ENV === "production" ? invariant.invariant(options.query, 48) : invariant.invariant(options.query, 'query option is required. You must specify your GraphQL document ' +
            'in the query option.');
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(options.query.kind === 'Document', 49) : invariant.invariant(options.query.kind === 'Document', 28) : process.env.NODE_ENV === "production" ? invariant.invariant(options.query.kind === 'Document', 50) : invariant.invariant(options.query.kind === 'Document', 'You must wrap the query string in a "gql" tag.');
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(!options.returnPartialData, 51) : invariant.invariant(!options.returnPartialData, 29) : process.env.NODE_ENV === "production" ? invariant.invariant(!options.returnPartialData, 52) : invariant.invariant(!options.returnPartialData, 'returnPartialData option only supported on watchQuery.');
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(!options.pollInterval, 53) : invariant.invariant(!options.pollInterval, 30) : process.env.NODE_ENV === "production" ? invariant.invariant(!options.pollInterval, 54) : invariant.invariant(!options.pollInterval, 'pollInterval option only supported on watchQuery.');
        return new Promise(function (resolve, reject) {
    ...
    QueryManager.prototype.clearStore = function () {
        this.cancelPendingFetches(process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(55) : new invariant.InvariantError(31) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(56) : new invariant.InvariantError('Store reset while query was in flight (not completed in link chain)'));
    ...
    QueryManager.prototype.fetchQueryByPolicy = function (queryInfo, options, networkStatus) {
        ...
        var resultsFromCache = function (diff, networkStatus) {
            ...
            if (process.env.NODE_ENV !== 'production' &&
                ...
                !equality.equal(data, {})) {
                process.env.NODE_ENV === "production" || (process.env.NODE_ENV === "production" || invariant.invariant.warn("Missing cache result fields: " + diff.missing.map(function (m) { return m.path.join('.'); }).join(', '), diff.missing));
            }
...
var ApolloClient = (function () {
    function ApolloClient(options) {
        ...
        if (!cache) {
            throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(1) : new invariant.InvariantError(1) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(2) : new invariant.InvariantError("To initialize Apollo Client, you must specify a 'cache' property " +
    ...
    ApolloClient.prototype.query = function (options) {
        ...
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(options.fetchPolicy !== 'cache-and-network', 3) : invariant.invariant(options.fetchPolicy !== 'cache-and-network', 2) : process.env.NODE_ENV === "production" ? invariant.invariant(options.fetchPolicy !== 'cache-and-network', 4) : invariant.invariant(options.fetchPolicy !== 'cache-and-network', 'The cache-and-network fetchPolicy does not work with client.query, because ' +
...
var Policies = (function () {
    ...
    Policies.prototype.setRootTypename = function (which, typename) {
        ...
        if (typename !== old) {
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(!old || old === which, 29) : invariant.invariant(!old || old === which, 34) : process.env.NODE_ENV === "production" ? invariant.invariant(!old || old === which, 30) : invariant.invariant(!old || old === which, "Cannot change root " + which + " __typename more than once");
    ...
    Policies.prototype.readField = function (objectOrReference, nameOrField, context, typename) {
        ...
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(objectOrReference, 31) : invariant.invariant(objectOrReference, 35) : process.env.NODE_ENV === "production" ? invariant.invariant(objectOrReference, 32) : invariant.invariant(objectOrReference, "Must provide an object or Reference when calling Policies#readField");
        var policies = this;
    ...
    return {
        ...
        mergeObjects: function (existing, incoming) {
            if (Array.isArray(existing) || Array.isArray(incoming)) {
                throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(33) : new invariant.InvariantError(36) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(34) : new invariant.InvariantError("Cannot automatically merge arrays");
            }
...
function computeKeyObject(response, specifier, aliasMap) {
    ...
    specifier.forEach(function (s) {
        if (Array.isArray(s)) {
            ...
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(hasOwn.call(response, responseName), 35) : invariant.invariant(hasOwn.call(response, responseName), 37) : process.env.NODE_ENV === "production" ? invariant.invariant(hasOwn.call(response, responseName), 36) : invariant.invariant(hasOwn.call(response, responseName), "Missing field '" + responseName + "' while computing key fields");
...
var StoreReader = (function () {
    ...
    StoreReader.prototype.executeSelectionSet = function (_a) {
        ...
        if (isReference(objectOrReference) &&
            ...
            return {
                result: {},
                missing: [missingFromInvariant(process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(83) : new invariant.InvariantError(48) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(84) : new invariant.InvariantError("Dangling reference to missing " + objectOrReference.__ref + " object"), context)],
            };
        }
            ...
            if (isField(selection)) {
                ...
                if (fieldValue === void 0) {
                    if (!addTypenameToDocument.added(selection)) {
                        getMissing().push(missingFromInvariant(process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(85) : new invariant.InvariantError(49) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(86) : new invariant.InvariantError("Can't find field '" + selection.name.value + "' on " + (isReference(objectOrReference)
                ...
                if (isInlineFragment(selection)) {
                    ...
                    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(fragment = fragmentMap[selection.name.value], 87) : invariant.invariant(fragment = fragmentMap[selection.name.value], 50) : process.env.NODE_ENV === "production" ? invariant.invariant(fragment = fragmentMap[selection.name.value], 88) : invariant.invariant(fragment = fragmentMap[selection.name.value], "No fragment named " + selection.name.value);
                }
    ...
    if (!field.selectionSet) {
        ...
        workSet_1.forEach(function (value) {
            if (value && typeof value === "object") {
                process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(!isReference(value), 89) : invariant.invariant(!isReference(value), 51) : process.env.NODE_ENV === "production" ? invariant.invariant(!isReference(value), 90) : invariant.invariant(!isReference(value), "Missing selection set for object of type " + getTypenameFromStoreObject(store, value) + " returned for query field " + field.name.value);
        ...
        workSet.forEach(function (selection) {
            ...
            if (isField(selection)) {
                ...
                if (typeof value !== 'undefined') {
                    ...
                    throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new invariant.InvariantError(81) : new invariant.InvariantError(47) : process.env.NODE_ENV === "production" ? new invariant.InvariantError(82) : new invariant.InvariantError("Missing field '" + resultFieldKey + "' in " + JSON.stringify(result, null, 2).substring(0, 100));
                }
            }
            else {
...
var ApolloProvider = function (_a) {
    ...
    return React.createElement(ApolloContext.Consumer, null, function (context) {
        ...
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant.invariant(context.client, 11) : invariant.invariant(context.client, 7) : process.env.NODE_ENV === "production" ? invariant.invariant(context.client, 12) : invariant.invariant(context.client, 'ApolloProvider was not passed a client instance. Make ' +
