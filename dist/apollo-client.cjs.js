...
function getFragmentQueryDocument(document, fragmentName) {
    ...
    document.definitions.forEach(function (definition) {
        if (definition.kind === 'OperationDefinition') {
            throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(75) : new tsInvariant.InvariantError(42) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(76) : new tsInvariant.InvariantError("Found a " + definition.operation + " operation" + (definition.name ? " named '" + definition.name.value + "'" : '') + ". " +
    ...
    if (typeof actualFragmentName === 'undefined') {
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(fragments.length === 1, 77) : tsInvariant.invariant(fragments.length === 1, 43) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(fragments.length === 1, 78) : tsInvariant.invariant(fragments.length === 1, "Found " + fragments.length + " fragments. `fragmentName` must be provided when there is not exactly 1 fragment.");
...
function getFragmentFromSelection(selection, fragmentMap) {
    switch (selection.kind) {
        ...
        case 'FragmentSpread': {
            ...
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(fragment, 79) : tsInvariant.invariant(fragment, 44) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(fragment, 80) : tsInvariant.invariant(fragment, "No fragment named " + selection.name.value + ".");
            return fragment;
        }
        default:
            return null;
...
function valueToObjectRepresentation(argObj, name, value, variables) {
    if (isIntValue(value) || isFloatValue(value)) {
        ...
        throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(27) : new tsInvariant.InvariantError(33) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(28) : new tsInvariant.InvariantError("The inline argument \"" + name.value + "\" of kind \"" + value.kind + "\"" +
...
function fieldNodeFromName(fieldName, args) {
    if (args === void 0) { args = {}; }
    return {
        kind: 'Field',
        name: {
        ...
        arguments: Object.keys(args).reduce(function (args, key) { return (tslib.__spreadArrays(args, [
            {
                kind: 'Argument',
                name: {
                    kind: 'Name',
...
function validateOperation(operation) {
    ...
    for (var _i = 0, _a = Object.keys(operation); _i < _a.length; _i++) {
        ...
        if (OPERATION_FIELDS.indexOf(key) < 0) {
            throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(39) : new tsInvariant.InvariantError(32) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(40) : new tsInvariant.InvariantError("illegal argument: " + key);
        }
    }
    return operation;
}
...
function checkDocument(doc) {
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(doc && doc.kind === 'Document', 59) : tsInvariant.invariant(doc && doc.kind === 'Document', 16) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(doc && doc.kind === 'Document', 60) : tsInvariant.invariant(doc && doc.kind === 'Document', "Expecting a parsed GraphQL document. Perhaps you need to wrap the query string in a \"gql\" tag? http://docs.apollostack.com/apollo-client/core.html#gql");
    var operations = doc.definitions
        .filter(function (d) { return d.kind !== 'FragmentDefinition'; })
        .map(function (definition) {
        if (definition.kind !== 'OperationDefinition') {
            throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(61) : new tsInvariant.InvariantError(17) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(62) : new tsInvariant.InvariantError("Schema type definitions not allowed in queries. Found: \"" + definition.kind + "\"");
        }
        return definition;
    });
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(operations.length <= 1, 63) : tsInvariant.invariant(operations.length <= 1, 18) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(operations.length <= 1, 64) : tsInvariant.invariant(operations.length <= 1, "Ambiguous GraphQL document: contains " + operations.length + " operations");
    return doc;
}
...
function getQueryDefinition(doc) {
    ...
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(queryDef && queryDef.operation === 'query', 65) : tsInvariant.invariant(queryDef && queryDef.operation === 'query', 19) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(queryDef && queryDef.operation === 'query', 66) : tsInvariant.invariant(queryDef && queryDef.operation === 'query', 'Must contain a query definition.');
    return queryDef;
}
function getFragmentDefinition(doc) {
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(doc.kind === 'Document', 67) : tsInvariant.invariant(doc.kind === 'Document', 20) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(doc.kind === 'Document', 68) : tsInvariant.invariant(doc.kind === 'Document', "Expecting a parsed GraphQL document. Perhaps you need to wrap the query string in a \"gql\" tag? http://docs.apollostack.com/apollo-client/core.html#gql");
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(doc.definitions.length <= 1, 69) : tsInvariant.invariant(doc.definitions.length <= 1, 21) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(doc.definitions.length <= 1, 70) : tsInvariant.invariant(doc.definitions.length <= 1, 'Fragment must have exactly one definition.');
    var fragmentDef = doc.definitions[0];
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(fragmentDef.kind === 'FragmentDefinition', 71) : tsInvariant.invariant(fragmentDef.kind === 'FragmentDefinition', 22) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(fragmentDef.kind === 'FragmentDefinition', 72) : tsInvariant.invariant(fragmentDef.kind === 'FragmentDefinition', 'Must be a fragment definition.');
    return fragmentDef;
}
function getMainDefinition(queryDoc) {
    ...
    throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(73) : new tsInvariant.InvariantError(23) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(74) : new tsInvariant.InvariantError('Expected a parsed GraphQL query with a query, mutation, subscription, or a fragment.');
}
...
var ApolloLink = (function () {
    ...
    ApolloLink.concat = function (first, second) {
        ...
        if (isTerminating(firstLink)) {
            process.env.NODE_ENV === "production" || (process.env.NODE_ENV === "production" || tsInvariant.invariant.warn(new LinkError("You are calling concat on a terminating link, which will have no effect", firstLink)));
            return firstLink;
        }
    ...
    ApolloLink.prototype.request = function (operation, forward) {
        throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(5) : new tsInvariant.InvariantError(4) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(6) : new tsInvariant.InvariantError('request is not implemented');
    };
...
var Reobserver = (function () {
    ...
    Reobserver.prototype.updatePolling = function () {
        ...
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(pollInterval, 57) : tsInvariant.invariant(pollInterval, 15) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(pollInterval, 58) : tsInvariant.invariant(pollInterval, 'Attempted to start a polling query without a polling interval.');
...
var ObservableQuery = (function (_super) {
    ...
    ObservableQuery.prototype.refetch = function (variables) {
        ...
        if (fetchPolicy === 'cache-only') {
            return Promise.reject(process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(25) : new tsInvariant.InvariantError(3) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(26) : new tsInvariant.InvariantError('cache-only fetchPolicy option should not be used together with query refetch.'));
        }
    ...
    ObservableQuery.prototype.subscribeToMore = function (options) {
        ...
        var subscription = this.queryManager
            ...
            error: function (err) {
                ...
                process.env.NODE_ENV === "production" || (process.env.NODE_ENV === "production" || tsInvariant.invariant.error('Unhandled GraphQL subscription error', err));
            },
        });
...
function defaultSubscriptionObserverErrorCallback(error) {
    process.env.NODE_ENV === "production" || (process.env.NODE_ENV === "production" || tsInvariant.invariant.error('Unhandled error', error.message, error.stack));
}
...
var serializeFetchParameter = function (p, label) {
    ...
    try {
        ...
        var parseError = process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(7) : new tsInvariant.InvariantError(5) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(8) : new tsInvariant.InvariantError("Network request failed. " + label + " is not serializable: " + e.message);
...
var checkFetcher = function (fetcher) {
    if (!fetcher && typeof fetch === 'undefined') {
        ...
        if (typeof window === 'undefined')
            library = 'node-fetch';
        throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(9) : new tsInvariant.InvariantError(6) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(10) : new tsInvariant.InvariantError('"fetch" has not been found globally and no fetcher has been ' +
...
function shouldInclude(_a, variables) {
    ...
    return getInclusionDirectives(directives).every(function (_a) {
        ...
        if (ifArgument.value.kind === 'Variable') {
            ...
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(evaledValue !== void 0, 91) : tsInvariant.invariant(evaledValue !== void 0, 38) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(evaledValue !== void 0, 92) : tsInvariant.invariant(evaledValue !== void 0, "Invalid variable referenced in @" + directive.name.value + " directive.");
        }
        else {
...
function getInclusionDirectives(directives) {
    ...
    if (directives && directives.length) {
        directives.forEach(function (directive) {
            ...
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(directiveArguments && directiveArguments.length === 1, 93) : tsInvariant.invariant(directiveArguments && directiveArguments.length === 1, 39) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(directiveArguments && directiveArguments.length === 1, 94) : tsInvariant.invariant(directiveArguments && directiveArguments.length === 1, "Incorrect number of arguments for the @" + directiveName + " directive.");
            var ifArgument = directiveArguments[0];
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(ifArgument.name && ifArgument.name.value === 'if', 95) : tsInvariant.invariant(ifArgument.name && ifArgument.name.value === 'if', 40) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(ifArgument.name && ifArgument.name.value === 'if', 96) : tsInvariant.invariant(ifArgument.name && ifArgument.name.value === 'if', "Invalid argument for the @" + directiveName + " directive.");
            var ifValue = ifArgument.value;
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(ifValue &&
                (ifValue.kind === 'Variable' || ifValue.kind === 'BooleanValue'), 97) : tsInvariant.invariant(ifValue &&
                (ifValue.kind === 'Variable' || ifValue.kind === 'BooleanValue'), 41) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(ifValue &&
                (ifValue.kind === 'Variable' || ifValue.kind === 'BooleanValue'), 98) : tsInvariant.invariant(ifValue &&
    ...
    test: function (directive) {
        ...
        if (willRemove) {
            if (!directive.arguments ||
                ...
                process.env.NODE_ENV === "production" || (process.env.NODE_ENV === "production" || tsInvariant.invariant.warn('Removing an @connection directive even though it does not have a key. ' +
                ...
                execute = function (selection) { return tslib.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return tslib.__generator(this, function (_a) {
                        ...
                        if (isInlineFragment(selection)) {
                            ...
                            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(fragment, 37) : tsInvariant.invariant(fragment, 14) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(fragment, 38) : tsInvariant.invariant(fragment, "No fragment named " + selection.name.value);
                        }
...
var QueryManager = (function () {
    ...
    QueryManager.prototype.stop = function () {
        ...
        this.cancelPendingFetches(process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(41) : new tsInvariant.InvariantError(24) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(42) : new tsInvariant.InvariantError('QueryManager stopped while query was in flight'));
    };
    ...
    QueryManager.prototype.mutate = function (_a) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(mutation, 43) : tsInvariant.invariant(mutation, 25) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(mutation, 44) : tsInvariant.invariant(mutation, 'mutation option is required. You must specify your GraphQL document in the mutation option.');
                        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(!fetchPolicy || fetchPolicy === 'no-cache', 45) : tsInvariant.invariant(!fetchPolicy || fetchPolicy === 'no-cache', 26) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(!fetchPolicy || fetchPolicy === 'no-cache', 46) : tsInvariant.invariant(!fetchPolicy || fetchPolicy === 'no-cache', "Mutations only support a 'no-cache' fetchPolicy. If you don't want to disable the cache, remove your fetchPolicy setting to proceed with the default mutation behavior.");
    ...
    QueryManager.prototype.query = function (options) {
        var _this = this;
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(options.query, 47) : tsInvariant.invariant(options.query, 27) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(options.query, 48) : tsInvariant.invariant(options.query, 'query option is required. You must specify your GraphQL document ' +
            'in the query option.');
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(options.query.kind === 'Document', 49) : tsInvariant.invariant(options.query.kind === 'Document', 28) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(options.query.kind === 'Document', 50) : tsInvariant.invariant(options.query.kind === 'Document', 'You must wrap the query string in a "gql" tag.');
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(!options.returnPartialData, 51) : tsInvariant.invariant(!options.returnPartialData, 29) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(!options.returnPartialData, 52) : tsInvariant.invariant(!options.returnPartialData, 'returnPartialData option only supported on watchQuery.');
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(!options.pollInterval, 53) : tsInvariant.invariant(!options.pollInterval, 30) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(!options.pollInterval, 54) : tsInvariant.invariant(!options.pollInterval, 'pollInterval option only supported on watchQuery.');
        return new Promise(function (resolve, reject) {
    ...
    QueryManager.prototype.clearStore = function () {
        this.cancelPendingFetches(process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(55) : new tsInvariant.InvariantError(31) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(56) : new tsInvariant.InvariantError('Store reset while query was in flight (not completed in link chain)'));
    ...
    QueryManager.prototype.fetchQueryByPolicy = function (queryInfo, options, networkStatus) {
        ...
        var resultsFromCache = function (diff, networkStatus) {
            ...
            if (process.env.NODE_ENV !== 'production' &&
                ...
                !equality.equal(data, {})) {
                process.env.NODE_ENV === "production" || (process.env.NODE_ENV === "production" || tsInvariant.invariant.warn("Missing cache result fields: " + diff.missing.map(function (m) { return m.path.join('.'); }).join(', '), diff.missing));
            }
...
var ApolloClient = (function () {
    function ApolloClient(options) {
        ...
        if (!cache) {
            throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(1) : new tsInvariant.InvariantError(1) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(2) : new tsInvariant.InvariantError("To initialize Apollo Client, you must specify a 'cache' property " +
    ...
    ApolloClient.prototype.query = function (options) {
        ...
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(options.fetchPolicy !== 'cache-and-network', 3) : tsInvariant.invariant(options.fetchPolicy !== 'cache-and-network', 2) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(options.fetchPolicy !== 'cache-and-network', 4) : tsInvariant.invariant(options.fetchPolicy !== 'cache-and-network', 'The cache-and-network fetchPolicy does not work with client.query, because ' +
...
var Policies = (function () {
    ...
    Policies.prototype.setRootTypename = function (which, typename) {
        ...
        if (typename !== old) {
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(!old || old === which, 29) : tsInvariant.invariant(!old || old === which, 34) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(!old || old === which, 30) : tsInvariant.invariant(!old || old === which, "Cannot change root " + which + " __typename more than once");
    ...
    Policies.prototype.getStoreFieldName = function (typename, nameOrField, variables) {
        ...
        if (typeof nameOrField === 'string') {
            ...
            if (variables && Object.keys(variables).length === 0) {
                field = tslib.__assign(tslib.__assign({}, field), { arguments: EMPTY });
            }
        }
        else {
            field = nameOrField;
    ...
    Policies.prototype.readField = function (objectOrReference, nameOrField, context, typename) {
        ...
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(objectOrReference, 31) : tsInvariant.invariant(objectOrReference, 35) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(objectOrReference, 32) : tsInvariant.invariant(objectOrReference, "Must provide an object or Reference when calling Policies#readField");
        var policies = this;
    ...
    return {
        ...
        mergeObjects: function (existing, incoming) {
            if (Array.isArray(existing) || Array.isArray(incoming)) {
                throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(33) : new tsInvariant.InvariantError(36) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(34) : new tsInvariant.InvariantError("Cannot automatically merge arrays");
            }
...
function computeKeyObject(response, specifier, aliasMap) {
    ...
    specifier.forEach(function (s) {
        if (Array.isArray(s)) {
            ...
            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(hasOwn.call(response, responseName), 35) : tsInvariant.invariant(hasOwn.call(response, responseName), 37) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(hasOwn.call(response, responseName), 36) : tsInvariant.invariant(hasOwn.call(response, responseName), "Missing field '" + responseName + "' while computing key fields");
...
var EntityStore = (function () {
    ...
    EntityStore.prototype.delete = function (dataId, fieldName, variables) {
        var _a;
        var storeFieldName = fieldName ? this.policies.getStoreFieldName(dataId, fieldName, variables) : null;
        return this.modify(dataId, storeFieldName ? (_a = {},
            _a[storeFieldName] = delModifier,
            _a) : delModifier);
    };
    EntityStore.prototype.evict = function (dataId, fieldName, variables) {
        var evicted = false;
        if (hasOwn$1.call(this.data, dataId)) {
...
var StoreReader = (function () {
    ...
    StoreReader.prototype.executeSelectionSet = function (_a) {
        ...
        if (isReference(objectOrReference) &&
            ...
            return {
                result: {},
                missing: [missingFromInvariant(process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(83) : new tsInvariant.InvariantError(48) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(84) : new tsInvariant.InvariantError("Dangling reference to missing " + objectOrReference.__ref + " object"), context)],
            };
        }
            ...
            if (isField(selection)) {
                ...
                if (fieldValue === void 0) {
                    if (!addTypenameToDocument.added(selection)) {
                        getMissing().push(missingFromInvariant(process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(85) : new tsInvariant.InvariantError(49) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(86) : new tsInvariant.InvariantError("Can't find field '" + selection.name.value + "' on " + (isReference(objectOrReference)
                ...
                if (isInlineFragment(selection)) {
                    ...
                    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(fragment = fragmentMap[selection.name.value], 87) : tsInvariant.invariant(fragment = fragmentMap[selection.name.value], 50) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(fragment = fragmentMap[selection.name.value], 88) : tsInvariant.invariant(fragment = fragmentMap[selection.name.value], "No fragment named " + selection.name.value);
                }
    ...
    if (!field.selectionSet) {
        ...
        workSet_1.forEach(function (value) {
            if (value && typeof value === "object") {
                process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(!isReference(value), 89) : tsInvariant.invariant(!isReference(value), 51) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(!isReference(value), 90) : tsInvariant.invariant(!isReference(value), "Missing selection set for object of type " + getTypenameFromStoreObject(store, value) + " returned for query field " + field.name.value);
        ...
        workSet.forEach(function (selection) {
            ...
            if (isField(selection)) {
                ...
                if (typeof value !== 'undefined') {
                    ...
                    throw process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(81) : new tsInvariant.InvariantError(47) : process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(82) : new tsInvariant.InvariantError("Missing field '" + resultFieldKey + "' in " + JSON.stringify(result, null, 2).substring(0, 100));
                }
            }
            else {
...
function toPromise(observable) {
    ...
    return new Promise(function (resolve, reject) {
        observable.subscribe({
            next: function (data) {
                if (completed) {
                    process.env.NODE_ENV === "production" || (process.env.NODE_ENV === "production" || tsInvariant.invariant.warn("Promise Wrapper does not support multiple results from Observable"));
                }
                else {
                    completed = true;
                    resolve(data);
...
var ApolloProvider = function (_a) {
    ...
    return React.createElement(ApolloContext.Consumer, null, function (context) {
        ...
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(context.client, 11) : tsInvariant.invariant(context.client, 7) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(context.client, 12) : tsInvariant.invariant(context.client, 'ApolloProvider was not passed a client instance. Make ' +
...
var ApolloConsumer = function (props) {
    ...
    var ApolloContext = getApolloContext();
    return React.createElement(ApolloContext.Consumer, null, function (context) {
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(context && context.client, 23) : tsInvariant.invariant(context && context.client, 8) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(context && context.client, 24) : tsInvariant.invariant(context && context.client, 'Could not find "client" in the context of ApolloConsumer. ' +
...
function parser(document) {
    ...
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(!!document && !!document.kind, 13) : tsInvariant.invariant(!!document && !!document.kind, 10) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(!!document && !!document.kind, 14) : tsInvariant.invariant(!!document && !!document.kind, "Argument of " + document + " passed to parser was not a valid GraphQL " +
    ...
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(!fragments.length ||
        (queries.length || mutations.length || subscriptions.length), 15) : tsInvariant.invariant(!fragments.length ||
        (queries.length || mutations.length || subscriptions.length), 11) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(!fragments.length ||
        (queries.length || mutations.length || subscriptions.length), 16) : tsInvariant.invariant(!fragments.length ||
        (queries.length || mutations.length || subscriptions.length), "Passing only a fragment to 'graphql' is not yet supported. " +
        "You must include a query, subscription or mutation as well");
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(queries.length + mutations.length + subscriptions.length <= 1, 17) : tsInvariant.invariant(queries.length + mutations.length + subscriptions.length <= 1, 12) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(queries.length + mutations.length + subscriptions.length <= 1, 18) : tsInvariant.invariant(queries.length + mutations.length + subscriptions.length <= 1, "react-apollo only supports a query, subscription, or a mutation per HOC. " +
    ...
    var definitions = queries.length
        ...
        : mutations.length
            ? mutations
            : subscriptions;
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(definitions.length === 1, 19) : tsInvariant.invariant(definitions.length === 1, 13) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(definitions.length === 1, 20) : tsInvariant.invariant(definitions.length === 1, "react-apollo only supports one definition per HOC. " + document + " had " +
...
var OperationData = (function () {
    ...
    OperationData.prototype.refreshClient = function () {
        ...
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(!!client, 99) : tsInvariant.invariant(!!client, 45) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(!!client, 100) : tsInvariant.invariant(!!client, 'Could not find "client" in the context or passed in as an option. ' +
    ...
    OperationData.prototype.verifyDocumentType = function (document, type) {
        ...
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(operation.type === type, 101) : tsInvariant.invariant(operation.type === type, 46) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(operation.type === type, 102) : tsInvariant.invariant(operation.type === type, "Running a " + requiredOperationName + " requires a graphql " +
...
function useApolloClient() {
    ...
    process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? tsInvariant.invariant(client, 21) : tsInvariant.invariant(client, 9) : process.env.NODE_ENV === "production" ? tsInvariant.invariant(client, 22) : tsInvariant.invariant(client, 'No Apollo Client instance can be found. Please ensure that you ' +
