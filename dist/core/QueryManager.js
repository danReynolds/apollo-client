...
var QueryManager = (function () {
    ...
    QueryManager.prototype.stop = function () {
        ...
        this.cancelPendingFetches(process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new InvariantError(41) : new InvariantError(24) : process.env.NODE_ENV === "production" ? new InvariantError(42) : new InvariantError('QueryManager stopped while query was in flight'));
    };
    ...
    QueryManager.prototype.mutate = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant(mutation, 43) : invariant(mutation, 25) : process.env.NODE_ENV === "production" ? invariant(mutation, 44) : invariant(mutation, 'mutation option is required. You must specify your GraphQL document in the mutation option.');
                        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant(!fetchPolicy || fetchPolicy === 'no-cache', 45) : invariant(!fetchPolicy || fetchPolicy === 'no-cache', 26) : process.env.NODE_ENV === "production" ? invariant(!fetchPolicy || fetchPolicy === 'no-cache', 46) : invariant(!fetchPolicy || fetchPolicy === 'no-cache', "Mutations only support a 'no-cache' fetchPolicy. If you don't want to disable the cache, remove your fetchPolicy setting to proceed with the default mutation behavior.");
    ...
    QueryManager.prototype.query = function (options) {
        var _this = this;
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant(options.query, 47) : invariant(options.query, 27) : process.env.NODE_ENV === "production" ? invariant(options.query, 48) : invariant(options.query, 'query option is required. You must specify your GraphQL document ' +
            'in the query option.');
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant(options.query.kind === 'Document', 49) : invariant(options.query.kind === 'Document', 28) : process.env.NODE_ENV === "production" ? invariant(options.query.kind === 'Document', 50) : invariant(options.query.kind === 'Document', 'You must wrap the query string in a "gql" tag.');
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant(!options.returnPartialData, 51) : invariant(!options.returnPartialData, 29) : process.env.NODE_ENV === "production" ? invariant(!options.returnPartialData, 52) : invariant(!options.returnPartialData, 'returnPartialData option only supported on watchQuery.');
        process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant(!options.pollInterval, 53) : invariant(!options.pollInterval, 30) : process.env.NODE_ENV === "production" ? invariant(!options.pollInterval, 54) : invariant(!options.pollInterval, 'pollInterval option only supported on watchQuery.');
    ...
    QueryManager.prototype.clearStore = function () {
        this.cancelPendingFetches(process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? new InvariantError(55) : new InvariantError(31) : process.env.NODE_ENV === "production" ? new InvariantError(56) : new InvariantError('Store reset while query was in flight (not completed in link chain)'));
    ...
    QueryManager.prototype.fetchQueryByPolicy = function (queryInfo, options, networkStatus) {
        ...
        var resultsFromCache = function (diff, networkStatus) {
            ...
            if (process.env.NODE_ENV !== 'production' &&
                ...
                !equal(data, {})) {
                process.env.NODE_ENV === "production" || (process.env.NODE_ENV === "production" || invariant.warn("Missing cache result fields: " + diff.missing.map(function (m) { return m.path.join('.'); }).join(', '), diff.missing));
            }
