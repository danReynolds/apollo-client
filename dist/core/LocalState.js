                ...
                execute = function (selection) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        if (isInlineFragment(selection)) {
                            ...
                            process.env.NODE_ENV === "production" ? process.env.NODE_ENV === "production" ? invariant(fragment, 37) : invariant(fragment, 14) : process.env.NODE_ENV === "production" ? invariant(fragment, 38) : invariant(fragment, "No fragment named " + selection.name.value);
                        }
